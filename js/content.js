...
window.SITE_CONTENT = {
    ...
    nav: [
        ...
        { id: "study", label: "日本語", emoji: "📚" },
        { id: "games", label: "Games", emoji: "🎮" },
        { id: "shrine", label: "Miku Shrine", emoji: "⛩️" },
    ],
    ...
    home: {
        ...
        aboutParagraphs: [
            ...
            "Jobby: No",
            "",
            "I love collecting Hatsune Miku figures, kawaii aesthetics and gaming. Sometimes I get sad... so if it's all right with you, can you cheer me up too?",
    ...
    url: "https://www.youtube.com/watch?v=YTinkSv10Qs",
            ...
            // Instagram removed (will not be shown)
            {
                label: "Discord",
            ...
            // Linktree removed (will not be shown)
        ],
    },
  ...
  jpGames: {
    ...
    quickLinks: {
        ...
        items: [
            ...
            // Instagram and Linktree removed from quick links to avoid iframe issues
        ],
    },
