...
(function initSfxEngine(){
  ...
  const MAP = {
    ...
    "Wish.reveal":[p("menu sounds/module change 1.wav"),p("menu sounds/module change 2.wav")],
    "Wish.pop":[p("button sounds+percussion/1.wav")],
    "Wish.high":[p("menu sounds/result (clear).wav"),p("result voice clips/miku/perfect.wav")],
    "Wish.mid":[p("result voice clips/miku/great.wav")],
    "Wish.low":[p("menu sounds/result (not clear).wav"),p("result voice clips/miku/standard.wav")],
